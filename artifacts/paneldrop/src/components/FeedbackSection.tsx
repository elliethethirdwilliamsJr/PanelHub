        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_400px]">
          ...
          <div className="lg:sticky lg:top-24 lg:self-start">
            <div className="manga-panel p-6">
              ...
              {/* Guidelines */}
              <div className="mt-6 p-4 border-2 border-black bg-[#fff4ed]">
                <h4 className="font-manga-body text-xs font-black uppercase tracking-[0.2em] mb-2">
                  Guidelines
                </h4>
                <ul className="space-y-1 text-[11px] font-manga-body text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    <span style={{ color: accent }}>•</span>
                    <span>No spam or offensive content</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span style={{ color: accent }}>•</span>
                    <span>Share honest feedback to help us improve</span>
                  </li>
                </ul>
              </div>
            </div>
